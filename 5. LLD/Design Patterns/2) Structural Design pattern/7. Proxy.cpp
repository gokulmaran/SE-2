/*Concept
The Proxy Pattern is used to provide a controlled access to an object by acting as an intermediary.
It is commonly used for lazy initialization, access control, logging, caching, or remote access.
==================================================================*/
#include <iostream>
using namespace std;
