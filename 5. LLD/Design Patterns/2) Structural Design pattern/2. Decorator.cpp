/*Concept:
The Decorator Pattern is a structural design pattern that allows behavior to be dynamically added to an object at runtime without modifying its original class.

Encapsulates additional functionalities inside "wrapper" classes.
Helps follow the Open/Closed Principle (open for extension, closed for modification).
=========================================================================================*/
#include <iostream>
using namespace std;
