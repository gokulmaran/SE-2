...
You need to clone existing objects instead of creating new ones from scratch.
Object creation is costly or complex, so copying an existing instance is more efficient.
============================================*/
#include <iostream>
using namespace std;
