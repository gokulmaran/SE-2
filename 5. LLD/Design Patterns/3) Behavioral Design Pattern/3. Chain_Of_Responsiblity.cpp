/*Chain of Responsibility--handles dynamically next handler
The Chain of Responsibility Pattern allows multiple handlers to process a request sequentially until one of them handles it. 
This pattern avoids coupling the sender to a specific handler.
*/
#include <iostream>
